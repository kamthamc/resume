...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  var ProfileData = {
    ...
    description: "Hi I\u2019m Chaitanya. Front End EngineerExperienced with all stages of the development cycle for dynamic web applications. Having an in-depth knowledge including advanced HTML5, CSS3, SASS, Java, ES6, Typescript, React, Angular. Contributed to open source projects.",
  ...
  // src/Containers/Profile/ProfileContainer.tsx
  var ProfileContainer = (props) => {
    return /* @__PURE__ */ React.createElement("main", null, props.resume.title);
  };

  // src/index.tsx
  var mountNode = document.getElementById("app");
  ReactDOM.render(/* @__PURE__ */ React.createElement(BrowserRouter, null, /* @__PURE__ */ React.createElement(Route, {
    path: "/",
    element: /* @__PURE__ */ React.createElement(ProfileContainer, {
      resume: ProfileData
    })
  })), mountNode);
})();
